      ...
      <div className="home-cards-container mt-5">
        <div className="home-card project-card">
          <div className="homeCard card">
            <div className="homeCard card-body">
              <h5 className="homeCard card-heading">Assigned Projects</h5>
              <p className="homeCard card-text">
        ...
        <div className="home-card feedback-card">
          <div className="homeCard card">
            <div className="homeCard card-body">
              <h5 className="homeCard card-heading">Feedback and Timesheet</h5>
              <p className="homeCard card-text">
                {hasEnteredTimesheet ? (
